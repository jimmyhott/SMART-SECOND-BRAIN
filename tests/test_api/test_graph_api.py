...
class TestGraphAPI:
    ...
    @patch('api.routes.v1.graph_api.create_graph_builder_with_collection')
    def test_ingest_endpoint_workflow_error(self, mock_create_graph_builder, client, mock_graph_builder, mock_compiled_graph):
        """Test ingestion when workflow fails."""
        # Setup mocks
        mock_create_graph_builder.return_value = mock_graph_builder
        mock_graph_builder.build.return_value = mock_compiled_graph
